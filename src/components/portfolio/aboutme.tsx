...
import resume from '/CL_Resume_2025_2.pdf';
        ...
        >
                ...
                >
                    <div className="about flex flex-col justify-center items-center mx-auto">
                        <img src={picture} alt="Picture"
                            className="w-64 h-64 md:h-96 md:w-96 xl:w-[32rem] xl:h-[32rem] rounded-full"
                        />
            ...
            <div className="about-me w-full mx-auto">
                ...
                <div
                    ...
                    >
                        <div className="work-experience mt-4 w-full">
                            <a className="flex items-center mb-2">
                            ...
                            <div className="space-y-3">
                                {experience.map((exp, index) => (
                                    <div key={index} className={"flex flex-row items-start"}>
                                        <div className={"w-fit font-light text-center"}>
                                            <span>{exp.date}</span>
                                        </div>
