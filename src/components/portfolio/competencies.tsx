...
export function Competencies() {
    return (
        <div className="mx-auto w-[90%] md:min-h-screen flex flex-col">
            <div>
                <h1 className="text-4xl sm:text-6xl font-bold relative z-20 bg-clip-text py-20 md:pb-0 text-center">
                    💡 Competencies
                </h1>
            </div>
            <div className={"h-full flex-grow flex justify-center items-center mx-auto"}>
                <div
                    className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-8 lg:gap-16">
