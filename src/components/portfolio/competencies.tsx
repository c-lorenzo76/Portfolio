...
export function Competencies (){
    return (
        <div className="mx-auto ml-6 mr-6">
            ...
            <div className="mt-4 mb-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                <Card className="technologies mx-auto w-[350px] sm:w-[300px] flex flex-col inter-var">
                    <CardHeader>
                        <CardTitle
                ...
                <Card className="libraries-frameworks border mx-auto w-[350px] sm:w-[300px] flex flex-col">
                    <CardHeader>
                ...
                <Card className="border mx-auto w-[350px] sm:w-[300px] flex flex-col">
                    <CardHeader>
                        <CardTitle className="text-center">
                            Tools
                        </CardTitle>
